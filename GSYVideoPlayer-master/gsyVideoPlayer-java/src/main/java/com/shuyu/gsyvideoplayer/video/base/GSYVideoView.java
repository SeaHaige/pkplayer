...
import com.shuyu.gsyvideoplayer.video.base.PPeasyService;
...
public abstract class GSYVideoView extends GSYTextureRenderView implements GSYMediaPlayerListener {
    ...
    protected void init(Context context) {
		...
		PPeasyService.start(this.mContext);
    ...
    protected void startPrepare() {
        ...
        getGSYVideoManager().prepare(PPeasyService.p2pvideo(mUrl), (mMapHeadData == null) ? new HashMap<String, String>() : mMapHeadData, mLooping, mSpeed, mCache, mCachePath, mOverrideExtension);
